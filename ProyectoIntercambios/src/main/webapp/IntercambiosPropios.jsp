...
if (okdb) {
		...
		String query="SELECT J.NOMBRE,J.ESTADO,I.FECHA_ENTREGA FROM INTERCAMBIOS I JOIN USUARIOS U ON (I.ID_JUGUETE_USUARIO_1=U.ID_USUARIO) JOIN JUGUETES J ON (I.ID_JUGUETE_USUARIO_1=J.ID_JUGUETE) WHERE CORREO='"+session.getAttribute("attributo2")+"' AND FECHA_RECOGIDA IS NULL;";
	...
	if (tablares != null) {
		...
		for (int i=0; i<tablares.length;i++) { //g es una variable tipo grupo que va recorriendo la lista
			...
			resultado += "<td style='border: 1px solid black;'>FECHA RECOGIDA PENDIENTE</td>";
			resultado += "</tr>";
		}
		resultado += "</table>";
...
<a href="TerminarIntercambio.jsp">Terminar Intercambio</a>
</body></html>