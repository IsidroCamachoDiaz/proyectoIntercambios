...
<body style="background-image: url(images/usuario.jpg); background-size: cover;">

<h1 style="color: white;">Borrar Usuario:</h1>
<form action="./BorrarUsuario" method="post" name="iniciosesion" id="iniciosesion">
<table style="text-align: left; border: none;">
<tr><td>
<input type="hidden" name="varoculta" value="secreto"/>
</td></tr><tr><td>Selecciona Correo:
<select name="select">
<%
for (int i=0; i<tablares.length;i++){
	%><option value="<%=tablares[i][0]%>"><%=tablares[i][3]%></option><%
}
%>
</select>	
</td></tr><tr><td>
