...
<h1 style="color: pink;">Crear Tipos de Juguetes</h1>
<form action="./AgregarTipo" method="post" name="iniciosesion" id="iniciosesion">
<table style="text-align: left; border: none;">
<tr><td>
<input type="hidden" name="varoculta" value="secreto"/>
</td></tr><tr><td>Tipo de Juguete:
	</td><td><input type="text" name="tipo" onkeypress="return compruebaalfan(this,event);" maxlength="30" value="" class="inputgris"/>
</td></tr><tr><td>
