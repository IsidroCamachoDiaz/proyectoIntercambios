...
<h1 style="color: pink;">Creacion de Cuenta</h1>
...
Correo:
	</td><td><input type="text" name="correo" onkeypress="return compruebaalfan(this,event);" maxlength="30" value="" class="inputgris"/>
